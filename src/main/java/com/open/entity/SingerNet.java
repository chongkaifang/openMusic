...
@Entity
@Table(name = "singer_net")
public class SingerNet {
    /**
     * 主键
     */
    @Id
    ...
    @Column(name = "singer_create_time")
    @JsonFormat(pattern="yyyy-MM-dd HH:mm:ss",timezone = "GMT+8")
    private Integer singerCreateTime;
    ...
    public Integer getSingerCreateTime() {
        return singerCreateTime;
    }

    public void setSingerCreateTime(Integer singerCreateTime) {
        this.singerCreateTime = singerCreateTime;
    }
}
