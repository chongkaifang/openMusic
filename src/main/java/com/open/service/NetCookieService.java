...
import com.open.dao.NetCookieDao;
...
@Service
public class NetCookieService {

    @Resource
    private NetCookieDao netCookieDao;
    @Resource
    private AlbumDao albumDao;
    @Resource
    private SongDao songDao;

    public NetCookie findByType(String type){
        return netCookieDao.findByType(type);
    }

    public NetCookie save(NetCookie netCookie) {
        return netCookieDao.save(netCookie);
    }
